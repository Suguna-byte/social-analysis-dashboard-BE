...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,social-analysis-dashboard-be-production.up.railway.app,social-analytics-dashboard-be-production.up.railway.app').split(',')
